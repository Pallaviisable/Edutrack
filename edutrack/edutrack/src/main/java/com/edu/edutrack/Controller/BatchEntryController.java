package com.edu.edutrack.Controller;

import com.edu.edutrack.Entity.BatchEntry;
import com.edu.edutrack.Service.BatchEntryService;
...
public class BatchEntryController
{
    ...
    @PutMapping("/id/{myid}")
    public ResponseEntity<?> updateEntryById(@PathVariable String myid, @RequestBody BatchEntry myentry)
    {
